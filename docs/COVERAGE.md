...
> **Note**: The `branches` threshold is set to 75% (not 80%) because NestJS controllers with extensive Swagger/OpenAPI decorators create metadata branches that don't require testing.
